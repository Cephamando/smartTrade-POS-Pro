    ...
    <div class="col-md-6">
        <div class="card shadow-sm h-100">
            ...
            <div class="list-group list-group-flush small fw-bold">
                ...
                <a href="index.php?page=receive_stock" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">Manage Products <i class="bi bi-chevron-right text-muted"></i></a>
