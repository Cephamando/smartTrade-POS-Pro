...
(23,	7,	9,	6,	50.00,	1,	'in_transit',	'2026-02-01 17:00:43',	'2026-02-01 17:00:47',	NULL);
...
(100,	58,	6,	1,	150.00,	0.00,	'pending',	NULL);
...
TRUNCATE `sales`;
INSERT INTO `sales` (`id`, `location_id`, `user_id`, `shift_id`, `total_amount`, `discount`, `total_tax`, `tip`, `final_total`, `payment_method`, `status`, `created_at`, `collected_by`, `payment_status`, `customer_name`, `amount_tendered`, `change_due`) VALUES
(1,	1,	3,	1,	130.00,	0.00,	0.00,	0.00,	130.00,	'cash',	'completed',	'2026-01-30 06:09:19',	NULL,	'paid',	'Walk-in',	0.00,	0.00),
(2,	1,	3,	1,	120.00,	0.00,	0.00,	0.00,	120.00,	'cash',	'completed',	'2026-01-30 11:45:13',	NULL,	'paid',	'Walk-in',	0.00,	0.00),
(3,	1,	4,	2,	250.00,	0.00,	0.00,	0.00,	250.00,	'cash',	'completed',	'2026-01-30 11:46:25',	NULL,	'paid',	'Walk-in',	0.00,	0.00),
(4,	1,	3,	1,	120.00,	0.00,	0.00,	0.00,	120.00,	'cash',	'completed',	'2026-01-30 11:48:08',	NULL,	'paid',	'Walk-in',	0.00,	0.00),
(5,	1,	3,	1,	120.00,	0.00,	0.00,	0.00,	120.00,	'cash',	'completed',	'2026-01-30 11:55:21',	NULL,	'paid',	'Walk-in',	0.00,	0.00),
(6,	1,	3,	1,	130.00,	0.00,	0.00,	0.00,	130.00,	'cash',	'completed',	'2026-01-30 11:59:26',	NULL,	'paid',	'Walk-in',	0.00,	0.00),
(7,	1,	3,	1,	360.00,	0.00,	0.00,	0.00,	360.00,	'cash',	'completed',	'2026-01-30 18:07:09',	NULL,	'paid',	'Walk-in',	0.00,	0.00),
(8,	2,	7,	5,	553.00,	0.00,	0.00,	0.00,	553.00,	'cash',	'completed',	'2026-01-31 03:56:30',	NULL,	'paid',	'Walk-in',	0.00,	0.00),
(9,	2,	7,	5,	134.00,	0.00,	0.00,	0.00,	134.00,	'cash',	'completed',	'2026-01-31 04:03:30',	NULL,	'paid',	'Walk-in',	0.00,	0.00),
(10,	2,	7,	5,	120.00,	0.00,	0.00,	0.00,	120.00,	'cash',	'completed',	'2026-01-31 04:03:39',	NULL,	'paid',	'Walk-in',	0.00,	0.00),
(11,	2,	7,	5,	650.00,	0.00,	0.00,	0.00,	650.00,	'cash',	'completed',	'2026-01-31 04:05:40',	'Mumba Bar-Manager',	'paid',	'Walk-in',	0.00,	0.00),
(12,	2,	7,	5,	1250.00,	0.00,	0.00,	0.00,	1250.00,	'cash',	'completed',	'2026-01-31 04:06:53',	'Mumba Bar-Manager',	'paid',	'Walk-in',	0.00,	0.00),
(13,	1,	3,	1,	130.00,	0.00,	0.00,	0.00,	130.00,	'cash',	'completed',	'2026-01-31 04:07:41',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(14,	1,	3,	1,	130.00,	0.00,	0.00,	0.00,	130.00,	'cash',	'completed',	'2026-01-31 04:07:45',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(15,	1,	3,	1,	120.00,	0.00,	0.00,	0.00,	120.00,	'cash',	'completed',	'2026-01-31 04:07:49',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(16,	1,	3,	1,	130.00,	0.00,	0.00,	0.00,	130.00,	'cash',	'completed',	'2026-01-31 04:07:53',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(17,	1,	3,	1,	120.00,	0.00,	0.00,	0.00,	120.00,	'cash',	'completed',	'2026-01-31 04:07:56',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(18,	1,	3,	1,	130.00,	0.00,	0.00,	0.00,	130.00,	'cash',	'completed',	'2026-01-31 04:08:01',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(19,	1,	3,	1,	130.00,	0.00,	0.00,	0.00,	130.00,	'cash',	'completed',	'2026-01-31 04:08:05',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(20,	1,	3,	1,	120.00,	0.00,	0.00,	0.00,	120.00,	'cash',	'completed',	'2026-01-31 12:40:41',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(21,	1,	3,	1,	130.00,	0.00,	0.00,	0.00,	130.00,	'cash',	'completed',	'2026-01-31 12:49:55',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(22,	1,	3,	1,	120.00,	0.00,	0.00,	0.00,	120.00,	'cash',	'completed',	'2026-01-31 12:53:08',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(23,	1,	3,	1,	250.00,	0.00,	0.00,	0.00,	250.00,	'cash',	'completed',	'2026-01-31 12:54:43',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(24,	1,	3,	1,	254.00,	0.00,	0.00,	0.00,	254.00,	'mobile_money',	'completed',	'2026-01-31 13:43:39',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(25,	1,	3,	1,	254.00,	0.00,	0.00,	0.00,	254.00,	'cash',	'completed',	'2026-01-31 13:46:37',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(26,	1,	3,	7,	130.00,	0.00,	0.00,	0.00,	130.00,	'cash',	'completed',	'2026-01-31 16:18:15',	'Restaurant Manager',	'paid',	'Walk-in',	0.00,	0.00),
(27,	1,	3,	7,	150.00,	0.00,	0.00,	0.00,	150.00,	'cash',	'completed',	'2026-01-31 16:41:19',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(28,	1,	3,	7,	150.00,	0.00,	0.00,	0.00,	150.00,	'mobile_money',	'completed',	'2026-01-31 16:43:11',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(29,	1,	3,	9,	150.00,	0.00,	0.00,	0.00,	150.00,	'cash',	'completed',	'2026-01-31 16:52:49',	'Mwale Kitchen Cashier',	'paid',	'Walk-in',	0.00,	0.00),
(30,	1,	3,	9,	750.00,	0.00,	0.00,	0.00,	750.00,	'cash',	'completed',	'2026-01-31 16:52:59',	NULL,	'paid',	'Walk-in',	0.00,	0.00),
(31,	4,	12,	10,	165.00,	0.00,	0.00,	0.00,	165.00,	'cash',	'completed',	'2026-01-31 17:06:19',	'Mary sales lady',	'paid',	'Walk-in',	0.00,	0.00),
(32,	1,	3,	NULL,	150.00,	0.00,	0.00,	0.00,	150.00,	'cash',	'completed',	'2026-02-01 03:26:50',	'Mwale Kitchen Cashier',	'paid',	'table 5',	500.00,	350.00),
(33,	1,	3,	NULL,	130.00,	0.00,	0.00,	0.00,	130.00,	'cash',	'completed',	'2026-02-01 04:01:18',	'Restaurant Manager',	'paid',	'Walk-in',	150.00,	20.00),
(34,	4,	15,	NULL,	165.00,	0.00,	0.00,	0.00,	165.00,	'card',	'completed',	'2026-02-01 05:38:54',	'Mary sales lady',	'paid',	'Walk-in',	0.00,	-165.00),
(35,	1,	4,	NULL,	264.00,	0.00,	0.00,	0.00,	264.00,	'pending',	'completed',	'2026-02-01 06:02:17',	'Mwale Kitchen Cashier',	'pending',	'Walk-in',	0.00,	0.00),
(36,	1,	4,	NULL,	185.00,	0.00,	0.00,	0.00,	185.00,	'pending',	'completed',	'2026-02-01 06:07:13',	'Mwale Kitchen Cashier',	'pending',	'Walk-in',	0.00,	0.00),
(37,	4,	12,	NULL,	130.00,	0.00,	0.00,	0.00,	130.00,	'cash',	'completed',	'2026-02-01 06:08:22',	'Mwape Restaurant Manager',	'paid',	'Walk-in',	0.00,	-130.00),
(38,	4,	15,	NULL,	120.00,	0.00,	0.00,	0.00,	120.00,	'cash',	'completed',	'2026-02-01 06:11:24',	'Mary sales lady',	'paid',	'Walk-in',	0.00,	-120.00),
(39,	4,	15,	NULL,	315.00,	0.00,	0.00,	0.00,	315.00,	'cash',	'completed',	'2026-02-01 06:32:34',	'Mary sales lady',	'paid',	'Walk-in',	0.00,	0.00),
(40,	1,	3,	NULL,	35.00,	0.00,	0.00,	0.00,	35.00,	'pending',	'completed',	'2026-02-01 07:24:19',	NULL,	'pending',	'Walk-in',	0.00,	0.00),
(41,	1,	4,	NULL,	130.00,	0.00,	0.00,	0.00,	130.00,	'pending',	'completed',	'2026-02-01 07:25:48',	'Mwale Kitchen Cashier',	'pending',	'Walk-in',	0.00,	0.00),
(42,	1,	4,	NULL,	130.00,	0.00,	0.00,	0.00,	130.00,	'pending',	'completed',	'2026-02-01 07:26:08',	'Mwale Kitchen Cashier',	'pending',	'Walk-in',	0.00,	0.00),
(43,	4,	12,	NULL,	130.00,	0.00,	0.00,	0.00,	130.00,	'card',	'completed',	'2026-02-01 07:26:44',	'Mwape Restaurant Manager',	'paid',	'Walk-in',	0.00,	0.00),
(44,	1,	4,	NULL,	130.00,	0.00,	0.00,	0.00,	130.00,	'pending',	'completed',	'2026-02-01 07:50:29',	'Mwale Kitchen Cashier',	'pending',	'Walk-in',	0.00,	0.00),
(45,	4,	15,	NULL,	120.00,	0.00,	0.00,	0.00,	120.00,	'cash',	'completed',	'2026-02-01 07:51:18',	'Mary sales lady',	'paid',	'Walk-in',	0.00,	-120.00),
(46,	4,	15,	NULL,	130.00,	0.00,	0.00,	0.00,	130.00,	'mobile_money',	'completed',	'2026-02-01 09:57:13',	'Mary sales lady',	'paid',	'Walk-in',	0.00,	0.00),
(47,	4,	12,	NULL,	120.00,	0.00,	0.00,	0.00,	120.00,	'cash',	'completed',	'2026-02-01 09:58:19',	'Mwape Restaurant Manager',	'paid',	'Walk-in',	0.00,	-120.00),
(48,	4,	12,	NULL,	250.00,	0.00,	0.00,	0.00,	250.00,	'cash',	'completed',	'2026-02-01 09:59:18',	'Mwape Restaurant Manager',	'paid',	'Walk-in',	0.00,	-250.00),
(49,	4,	12,	12,	150.00,	0.00,	0.00,	0.00,	150.00,	'cash',	'completed',	'2026-02-01 10:45:15',	'Mary sales lady',	'paid',	'Walk-in',	160.00,	10.00),
(50,	4,	12,	12,	260.00,	0.00,	0.00,	0.00,	260.00,	'cash',	'completed',	'2026-02-01 12:21:58',	'Mary sales lady',	'paid',	'Walk-in',	500.00,	240.00),
(51,	4,	12,	13,	539.00,	0.00,	0.00,	0.00,	539.00,	'mobile_money (MTN)',	'completed',	'2026-02-01 12:28:34',	'Mary sales lady',	'paid',	'Walk-in',	700.00,	161.00),
(52,	4,	15,	14,	264.00,	0.00,	0.00,	0.00,	264.00,	'cash',	'completed',	'2026-02-01 12:58:27',	NULL,	'paid',	'Walk-in',	400.00,	136.00),
(53,	4,	15,	14,	130.00,	0.00,	0.00,	0.00,	130.00,	'cash',	'completed',	'2026-02-01 13:00:05',	NULL,	'paid',	'Walk-in',	200.00,	70.00),
(54,	4,	15,	14,	130.00,	0.00,	0.00,	0.00,	130.00,	'cash',	'completed',	'2026-02-01 13:02:09',	NULL,	'paid',	'Walk-in',	150.00,	20.00),
(55,	4,	15,	14,	150.00,	0.00,	0.00,	0.00,	150.00,	'cash',	'completed',	'2026-02-01 13:04:06',	NULL,	'paid',	'Walk-in',	0.00,	-150.00),
(56,	4,	15,	14,	35.00,	0.00,	0.00,	0.00,	35.00,	'cash',	'completed',	'2026-02-01 13:08:33',	'Mwape_Res_Bar_manager',	'paid',	'Walk-in',	50.00,	15.00),
(57,	4,	15,	14,	260.00,	0.00,	0.00,	0.00,	260.00,	'cash',	'completed',	'2026-02-01 14:27:36',	'Mwape_Res_Bar_manager',	'paid',	'Walk-in',	400.00,	140.00),
(58,	4,	15,	14,	150.00,	0.00,	0.00,	0.00,	150.00,	'pending',	'completed',	'2026-02-01 14:28:55',	NULL,	'pending',	'Walk-in',	0.00,	-150.00);
